...
class Business_Chatbot_Creator:
    ...
    def create_custom_prompt(self):
        custom_prompt_temp = PromptTemplate(
            template= self.prompt_temp, input_variables= self.input_variables
        )
        return custom_prompt_temp
    
    def load_llm(self):
        llm = CTransformers(model=self.__model_ckpt,
    ...
    def create_business_chatbot(self):
